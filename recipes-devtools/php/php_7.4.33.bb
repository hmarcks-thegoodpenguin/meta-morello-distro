SUMMARY = "A server-side, HTML-embedded scripting language - sourced from Dunfell"
...
# PACKAGECONFIG[openssl] = "--with-openssl,--without-openssl,openssl-dunfell"
...
do_configure:prepend () {
    # export OPENSSL_LIBS="-L${STAGING_DIR_TARGET}${libdir} -lcrypto.1.1 -lssl.1.1"
    # export OPENSSL_CFLAGS="-I${STAGING_DIR_TARGET}${includedir}/openssl.1.1"
